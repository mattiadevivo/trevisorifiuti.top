...
export function AccountPage() {
  ...
  const [notificationPreference] = createResource<NotificationPreference>(
    async () => {
      if (auth.user()) {
  ...
  createEffect(() => {
    ...
    if (auth.user() && notificationPreference()) {
      const preferences = notificationPreference();
      setTelegramChatId(
        (preferences.notification_info as TelegramNotificationInfo).chat_id
      );
      setSelectedMunicipality(preferences.municipality_id);
    }
  });
                ...
                <div class="space-y-2 text-sm">
                  <div class="flex justify-between">
                    ...
                    <div class="badge badge-outline">
                      {isNotificationPreferenceConfigured()
                        ? "Configured"
                        : "Not Configured"}
                    </div>
                  </div>
                  <div class="flex justify-between">
                    ...
                    <span class="font-medium">
                      ...
                      municipalities()
                        ? municipalities()?.find(
                            (m) =>
                              m.id === notificationPreference()?.municipality_id
                          )?.name
                        : "Not set"}
                    </span>
                  </div>
