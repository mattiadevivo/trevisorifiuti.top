				...
				<form onSubmit={props.onSubmit} class="space-y-6">
					...
					<div>
						<label class="label" for="municipality">
							<span class="label-text font-semibold">{t("account.form.municipalityLabel")}</span>
						...
						<span class="text-sm text-base-content">{t("account.form.municipalityHelp")}</span>
					</div>

					{/* Telegram Chat ID */}
					<div>
						<label class="label" for="telegram-chat-id">
							<span class="label-text font-semibold">{t("account.form.chatIdLabel")}</span>
							<span class="label-text-alt text-error">*</span>
						</label>
						<div class="input-group">
							<input
								id="telegram-chat-id"
								type="text"
								placeholder={t("account.form.chatIdPlaceholder")}
								...
								disabled={props.isSubmitting()}
							/>
							<button type="button" class="btn btn-outline" onClick={props.onToggleInstructions}>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
									viewBox="0 0 24 24"
						...
						<label for="telegram-chat-id">
							<span class="text-sm text-base-content">{t("account.form.chatIdHelp")}</span>
						</label>
					</div>
